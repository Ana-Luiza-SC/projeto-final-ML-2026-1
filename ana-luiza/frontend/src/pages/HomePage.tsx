...
type Props = { onOpenDisciplines: () => void; onOpenMatriculaImport?: () => void };
  ...
  return <div className="page dashboard-page">
    ...
    {loading ? <LoadingState label="Carregando seu semestre..." /> : <>
      <section className="dashboard-stats" aria-label="Resumo acadêmico">
        ...
        <article className="quick-action"><div><span className="action-kicker">Planejamento</span><h2>Monte sua semana de estudos</h2><p>Distribua o tempo disponível entre as disciplinas cadastradas.</p></div><button type="button" onClick={() => { window.location.hash = "/study-plan"; }}>Criar planejamento</button></article>
